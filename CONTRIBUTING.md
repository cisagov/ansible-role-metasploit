...
issue](https://github.com/cisagov/ansible-role-metasploit/issues) in
...
request](https://github.com/cisagov/ansible-role-metasploit/pulls), you
...
```console
cd ansible-role-metasploit
pyenv virtualenv <python_version_to_use> ansible-role-metasploit
pyenv local ansible-role-metasploit
